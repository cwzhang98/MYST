...
common.tensorboard_logdir="${PROJECT_ROOT}"/st_train_log4 \
checkpoint.save_dir="${PROJECT_ROOT}"/checkpoint4 \
checkpoint.restore_file="${PROJECT_ROOT}"/checkpoint4/checkpoint_last.pt \
